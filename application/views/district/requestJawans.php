            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a class="text-muted">Send Request</a>
                        </li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Request For Jawans</h3>
                        </div>
                        <!--begin::Form-->
                        <form id="requestForm" action="<?= base_url('district/registerRequest') ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#addDepartmentModal">Add Department</a>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="number" name="jawans[<?= $block->id ?>]" min="0"
                                                            ...
                                                            placeholder="Enter total number of jawans for <?= $block->name ?>"
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="demandNumber" name="demandNumber"
                        placeholder="Enter Demand Number" required>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        $('#saveDepartment').click(function () {
            ...
            $.ajax({
                url: '<?= base_url('district/registerDepartment') ?>',
                type: 'POST',
                dataType: 'json',
                data: {
                    name: departmentName
                ...
                error: function (xhr, status, error) {
                    $('#error').html('<div class="alert alert-danger alert-dismissible fade show" role="alert">Error: ' + error + '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                }
            });
        });
    });

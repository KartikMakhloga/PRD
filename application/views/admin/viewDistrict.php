        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total"><?= count($districts) ?>
                        Total</span>
                    <form class="ml-5">
            ...
            <div class="d-flex align-items-center">
                ...
                <!--end::Button-->
                <!--begin::Button-->
                <a href="<?= base_url('district/create') ?>"
                    class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add District</a>
                <!--end::Button-->
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">District Management
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function (row) {
                            return '\
                            <a href="'+ baseUrl + 'editDistrict/' + row.id + '" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
                                <i class="la la-edit text-warning"></i>\
                            </a>\
                            <a href="'+ baseUrl + 'deleteDistrict/' + row.id + '" class="btn btn-sm btn-clean btn-icon" title="Delete">\

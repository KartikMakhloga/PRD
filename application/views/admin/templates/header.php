...
<body id="kt_body"
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		<!--begin::Logo-->
		<a href="<?= base_url() ?>">
			<img alt="Logo" src="<?= base_url(); ?>assets/media/logos/uttlogo.jpg" class="max-h-60px" style="    border: 1px solid;
	border-radius: 50%;" />
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
					...
					<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
						...
						<ul class="menu-nav">
							...
							<?php if ($this->session->userdata('role_name') == 'admin'): ?>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?= base_url('district/create') ?>" class="menu-link">
													<span class="menu-text">Add District</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="<?= base_url('district/view') ?>" class="menu-link">
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">Add Block</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?= base_url('block/create') ?>" class="menu-link">
													<span class="menu-text">Add Block</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="<?= base_url('block/view') ?>" class="menu-link">
													<span class="menu-text">All Block</span>
												</a>
											</li>
										</ul>
									</div>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">Add Jawans</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?= base_url('jawan/create') ?>" class="menu-link">
													<span class="menu-text">Add Jawan</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="<?= base_url('jawan/view') ?>" class="menu-link">
													<span class="menu-text">All Jawans</span>
												</a>
											</li>
										</ul>
									</div>
							...
							<?php if ($this->session->userdata('role_name') == 'district'): ?>
								...
								<?php if ($this->session->userdata('blocks')): ?>
									<?php foreach ($this->session->userdata('blocks') as $block): ?>
										<li class="menu-item" aria-haspopup="true">
											</span>
											<a href="<?= base_url('district/BlockJawans/' . $block->id) ?>" class="menu-link">
												<span class="svg-icon menu-icon">
													<!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
													<svg xmlns="http://www.w3.org/2000/svg"
														xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
												...
												<!--end::Svg Icon-->
												<span class="menu-text "><?= $block->name ?></span>
											</a>
										</li>
									<?php endforeach; ?>
								<?php endif; ?>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">Requests For Jawans</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											<li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Add Request</span>
												</span>
											</li>

											<li class="menu-item" aria-haspopup="true">
												<a href="<?= base_url('district/requestJawans') ?>" class="menu-link">
													<span class="menu-text">Add Requests</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="<?= base_url('district/allRequest') ?>" class="menu-link">
								...
								<li class="menu-item" aria-haspopup="true">
									...
									<a href="<?= base_url('district/report') ?>" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
											<svg xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
							...
							<?php endif; ?>
							<?php if ($this->session->userdata('role_name') == 'block'): ?>
								<li class="menu-section">
									<h4 class="menu-text"><?= $this->session->userdata('name'); ?></h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">Jawan Details</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?= base_url('block/jawanDetails') ?>" class="menu-link">
													<span class="menu-text">All Jawans</span>
												</a>
											</li>
						...
						<div class="topbar">
														...
														<div class="symbol symbol-40 symbol-light-info mr-5">
															<span class="symbol-label">
																<span class="svg-icon svg-icon-lg svg-icon-info">
																	<!--begin::Svg Icon | path:<?= base_url(); ?>assets/media/svg/icons/Communication/Shield-user.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg"
																		xmlns:xlink="http://www.w3.org/1999/xlink"
																		width="24px" height="24px" viewBox="0 0 24 24"
																		version="1.1">
							...
							<div class="topbar-item">
								<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
									...
									<G class="symbol symbol-lg-35 symbol-25 symbol-light-success">

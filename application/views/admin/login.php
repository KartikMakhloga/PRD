		...
		<div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
			...
			<div
				...
				<div class="login-content d-flex flex-column pt-lg-0 pt-12">
					...
					<a href="#" class="login-logo pb-xl-20 pb-15">
						<img src="<?= base_url() ?>assets/media/logos/uttlogo.jpg" class="max-h-120px" alt="" />
					</a>
					<!--end::Logo-->
					<!--begin::Signin-->
					<div class="login-form">
						<!--begin::Form-->
						<form action="<?= base_url('signin'); ?>" method="post" class="form" id="kt_login_singin_form">
							<!--begin::Title-->
			...
			<div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
				<div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
					style="background-image: url(<?= base_url() ?>assets/media/svg/illustrations/login-visual-4.svg);">
					<!--begin::Aside title-->
					<h3 class="pt-lg-40 pl-lg-20 pb-lg-0 pl-10 py-20 m-0 d-flex justify-content-lg-start font-weight-boldest display5 display1-md text-white"
						style="font-size: 42px !important">प्रान्तीय रक्षक दल विभाग<br>
					</h3>
					<p style="color: white;
	font-size: 25px;
	padding-left: 75px;">उत्तराखण्ड सरकार</p>
					<div>
						<img src="https://currentaffairs.adda247.com/wp-content/uploads/multisite/sites/5/2022/09/06082032/1586156073_wAAylU_Uttarakhand_Govt_Logo.jpg" alt="" style="width:43%;">
					</div>

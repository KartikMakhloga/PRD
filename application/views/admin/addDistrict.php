    ...
    <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">All Districts</a>
                        </li>
                        <li class="breadcrumb-item text-muted">
                            <a class="text-muted">District Registration</a>
                        </li>
            ...
            <div class="d-flex align-items-center">
                <!--begin::Actions-->
                <a href="view" class="btn btn-light-primary font-weight-bolder btn-sm">View Districts</a>
                <!--end::Actions-->
            </div>
            <!--end::Toolbar-->
        </div>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form action="<?= base_url('registerDistrict') ?>" method="post">
												<div class="card-body">
													<!-- <div class="form-group mb-8">
														<div class="alert alert-custom alert-default" role="alert">
															...
															<div class="alert-text">Please add District.</div>
														</div>
													</div> -->
